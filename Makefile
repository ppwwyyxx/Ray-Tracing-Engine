...
# Generated by qmake (3.0) (Qt 5.0.2) on: Sun Jun 9 23:52:16 2013
...
CXXFLAGS      = -m64 -pipe -O3 -std=c++11 -Isrc/include -DDEBUG -march=x86-64 -mtune=generic -O2 -pipe -fstack-protector --param=ssp-buffer-size=4 -Wall -W -D_REENTRANT -fPIE $(DEFINES)
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/obj/Q3DViewer1.0.0/ && $(COPY_FILE) --parents mainwindow.h src/include/geometry/aabb.hh src/include/geometry/geometry.hh src/include/geometry/infplane.hh src/include/geometry/ray.hh src/include/geometry/sphere.hh src/include/material/surface.hh src/include/material/texture.hh src/include/renderable/light.hh src/include/renderable/plane.hh src/include/renderable/renderable.hh src/include/renderable/sphere.hh src/include/color.hh src/include/common.hh src/include/debugutils.hh src/include/image.hh src/include/matrix.hh src/include/space.hh src/include/utils.hh src/include/view.hh src/include/viewer.hh build/obj/Q3DViewer1.0.0/ && $(COPY_FILE) --parents Qt.cpp mainwindow.cpp src/color.cc src/debugutils.cc src/light.cc src/plane.cc src/space.cc src/sphere.cc src/surface.cc src/texture.cc src/utils.cc src/view.cc build/obj/Q3DViewer1.0.0/ && $(COPY_FILE) --parents mainwindow.ui build/obj/Q3DViewer1.0.0/ && (cd `dirname build/obj/Q3DViewer1.0.0` && $(TAR) Q3DViewer1.0.0.tar Q3DViewer1.0.0 && $(COMPRESS) Q3DViewer1.0.0.tar) && $(MOVE) `dirname build/obj/Q3DViewer1.0.0`/Q3DViewer1.0.0.tar.gz . && $(DEL_FILE) -r build/obj/Q3DViewer1.0.0
