...
# Generated by qmake (3.0) (Qt 5.0.2) on: Thu Jun 20 16:31:36 2013
# Project:  objviewer.pro
# Template: app
# Command: /usr/lib/qt/bin/qmake -o Makefile objviewer.pro
#############################################################################
...
CXXFLAGS      = -m64 -pipe -std=c++11 -DDEBUG -fopenmp -Isrc/include -O3 `Magick++-config --cppflags` `pkg-config --cflags opencv` -march=x86-64 -mtune=generic -O2 -pipe -fstack-protector --param=ssp-buffer-size=4 -Wall -W -D_REENTRANT -fPIE $(DEFINES)
...
Makefile: objviewer.pro /usr/lib/qt/mkspecs/linux-g++-64/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/shell-unix.conf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/lib/libQt5Gui.prl \
		/lib/libQt5Core.prl
	$(QMAKE) -o Makefile objviewer.pro
