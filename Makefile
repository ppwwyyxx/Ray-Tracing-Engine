...
# Generated by qmake (3.0) (Qt 5.0.2) on: Thu Jun 20 01:43:32 2013
...
CXXFLAGS      = -m64 -pipe -O3 -std=c++11 -Isrc/include -DDEBUG -fopenmp `Magick++-config --cppflags` -march=x86-64 -mtune=generic -O2 -pipe -fstack-protector --param=ssp-buffer-size=4 -Wall -W -D_REENTRANT -fPIE $(DEFINES)
...
LIBS          = $(SUBLIBS) -L/usr/X11R6/lib64 `Magick++-config --libs` -fopenmp -lQt5Widgets -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = Qt.cpp \
		...
		src/texture.cc \
		src/view.cc \
		src/mesh_simplifier.cc build/moc/moc_mainwindow.cpp
