...
# Generated by qmake (3.0) (Qt 5.0.2) on: Thu Jun 20 11:36:22 2013
...
CXXFLAGS      = -m64 -pipe -std=c++11 -DDEBUG -fopenmp -Isrc/include `Magick++-config --cppflags` `pkg-config --cflags opencv` -march=x86-64 -mtune=generic -O2 -pipe -fstack-protector --param=ssp-buffer-size=4 -Wall -W -D_REENTRANT -fPIE $(DEFINES)
