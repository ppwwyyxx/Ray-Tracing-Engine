...
# Generated by qmake (3.0) (Qt 5.0.2) on: Thu Jun 20 12:26:25 2013
...
CFLAGS        = -m64 -pipe -march=x86-64 -mtune=generic -O0 -pipe -fstack-protector --param=ssp-buffer-size=4 -Wall -W -D_REENTRANT -fPIE $(DEFINES)
CXXFLAGS      = -m64 -pipe -std=c++11 -DDEBUG -fopenmp -Isrc/include -g `Magick++-config --cppflags` `pkg-config --cflags opencv` -march=x86-64 -mtune=generic -O0 -pipe -fstack-protector --param=ssp-buffer-size=4 -Wall -W -D_REENTRANT -fPIE $(DEFINES)
...
LINK          = g++
LFLAGS        = -m64 -Wl,-O0,--sort-common,--as-needed,-z,relro -Wl,-O0
