% File: diary.tex
% Date: Wed Jun 19 22:12:36 2013 +0800
...
\begin{minipage}[b]{0.46\linewidth}
  \centering
  \includegraphics[width=\textwidth]{res/unsimplified_smooth.png}
  \caption*{未简化,含法向插值}
\end{minipage}

\begin{minipage}[b]{0.46\linewidth}
  \centering
  \includegraphics[width=\textwidth]{res/simplified_nosmooth.png}
  \caption*{简化至20\%, 无法向插值}
\end{minipage}
\begin{minipage}[b]{0.46\linewidth}
  \centering
  \includegraphics[width=\textwidth]{res/simplified_smooth.png}
  \caption*{简化至20\%, 含法向插值}
\end{minipage}
